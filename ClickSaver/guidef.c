...
// **** Exits tab (grouped Whompahs & Grids) ****
PU_ACTION_OBJDEF, CS_EXITS_TAB, ( PUU32 )"VerGroup", 0,
	PUM_ADDCHILD, PU_LABEL("Accept misisons near Whompah and Grid exits."),
	PUM_ADDCHILD, PU_LABEL(" "),

    PUM_ADDCHILD, PU_TITLE( "Whompahs" ),
	PUM_ADDCHILD, PU_LEFT_VERGROUP,
    PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_CLAN_CB, "Clan" ),
    PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_NEUTRAL_CB, "Neutral" ),
    PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_OMNI_CB, "Omni" ),
	PU_ENDGROUP,
    PUM_ADDCHILD, PU_TITLE( "Grid Exits" ),
	PUM_ADDCHILD, PU_LEFT_VERGROUP,
	PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_GRID_CLAN_CB, "Clan" ),
	PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_GRID_NEUTRAL_CB, "Neutral" ),
	PUM_ADDCHILD, PU_CHECKBOX( CS_EXITS_GRID_OMNI_CB, "Omni" ),
	PU_ENDGROUP,
